      ...
      <Form {...layout} ref={this.formRef} onFinish={onFinish}>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "请输入报告/条令中文名称！",
            },
          ]}>
          <Input placeholder="请输入报告/条令中文名称" />
        </Form.Item>
        <Form.Item
          name="name"
          label="报告/条令名称（英）"
          rules={[
            {
              required: true,
              message: "请输入报告/条令英文名称！",
            },
          ]}>
          <Input placeholder="请输入报告/条令英文名称" />
        </Form.Item>
        <Form.Item
          name="article"
          label="作者"
          ...
          <Input placeholder="请输入报告/条令作者姓名" />
        </Form.Item>
        <Form.Item
          name="buildDate"
          label="发布日期"
          rules={[
            {
              required: true,
              message: "请选择报告/条令发布日期！",
            },
          ]}>
          <DatePicker
            placeholder="请选择报告/条令发布日期！"
            format="YYYY-MM-DD"
          />
        </Form.Item>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "请选择报告/条令发布机构！",
            },
          ]}>
          <Select
            style={{ width: 160 }}
            placeholder="请选择报告/条令发布机构！"
            allowClear>
        ...
        <Form.Item name="desc" label="简介">
          <Input.TextArea placeholder="请输入报告/条令简介" rows={4} />
        </Form.Item>
