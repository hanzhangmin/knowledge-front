...
import SingleAddForm from "components/Resource/Infomation/LiteratureSingleAdd";
import MoreAdd from "components/1-common/FileUploader/MoreFileUpload";
import LiteratureEditer from "components/Resource/Infomation/LiteratureEditer";
import LiteratureDetails from "components/Resource/Infomation/LiteratureDetails";
    ...
    return (
      <div>
        ...
        <Drawer
          ...
          <LiteratureDetails requestData={requestData}></LiteratureDetails>
        </Drawer>
        <Drawer
          style={{ height: "100vh" }}
          width={client}
          ...
          <LiteratureEditer requestData={requestData}></LiteratureEditer>
        </Drawer>
