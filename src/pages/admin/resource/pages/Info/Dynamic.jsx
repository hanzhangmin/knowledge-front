...
import SingleAddForm from "components/Resource/Infomation/DynamicSingleAdd";
import MoreAdd from "components/1-common/FileUploader/MoreFileUpload";
import DynamicEditer from "components/Resource/Infomation/DynamicEditer";
import DynamicDetails from "components/Resource/Infomation/DynamicDetails";
    ...
    return (
      <div>
        ...
        <Drawer
          ...
          <DynamicDetails requestData={requestData}></DynamicDetails>
        </Drawer>
        <Drawer
          style={{ height: "100vh" }}
          width={client}
          ...
          <DynamicEditer requestData={requestData}></DynamicEditer>
        </Drawer>
